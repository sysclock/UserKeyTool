...
const U8 g_OnceTimeRangeStr[15]={0xB7,0xB6,0xCE,0xA7,0x3A,'1','~','4','8',' ',0xD0,0xA1,0xCA,0xB1,0}; //单次时长范围
...
const U8 g_OnceTimeLongStr[15]={0xB5,0xA5,0xB4,0xCE,0xCA,0xB1,0xB3,0xA4,' ',' ',0xD0,0xA1,0xCA,0xB1,0};//单次时长  分钟
