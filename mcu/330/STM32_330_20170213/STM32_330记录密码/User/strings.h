...
_STRINGSDEC_ const U8 g_PCPowerOnStrEn[15];
_STRINGSDEC_ const U8 g_PCShutOffStrEn[15];

_STRINGSDEC_ const U8 g_MenuPCPowerOnStr[15];
_STRINGSDEC_ const U8 g_MenuPCShutOffStr[15];

_STRINGSDEC_ const U8 g_LogHadReadOut[17];
_STRINGSDEC_ const U8 g_noLog[21];

_STRINGSDEC_ const U8 g_SupportTechStr[15];
_STRINGSDEC_ U8 g_TechSupportTel1[13];
_STRINGSDEC_ U8 g_ContactTel2[13];
_STRINGSDEC_  U8 g_MachineTypeXPStr[21];
_STRINGSDEC_  const U8 gc_MachineType[6];

//_STRINGSDEC_ const U8 g_MachineTypeXPIDStr[21];
_STRINGSDEC_ const U8 g_SyncToLEDStr[21];
_STRINGSDEC_ const U8 g_SyncToLEDStrEn[20];
...
_STRINGSDEC_ const U8 g_Factory[6];
...
_STRINGSDEC_ const U8 g_NoUseStr[21];
_STRINGSDEC_ const U8 g_WelcomeUseStr[21];
...
_STRINGSDEC_ const U8 HDMI2En[9];
#endif
...
//_STRINGSDEC_ const U8 g_AVOrYPbPrStr[19];
//_STRINGSDEC_ const U8 g_AVOrYPbPrStrEn[14];
//_STRINGSDEC_ const U8 g_SelAV4Str[8];
//_STRINGSDEC_ const U8 g_SelAV4StrEn[11];
//_STRINGSDEC_ const U8 g_SelYPbPrStr[10];
//_STRINGSDEC_ const U8 g_SelYPbPrStrEn[13];
_STRINGSDEC_ const U8 g_Language[11];
_STRINGSDEC_ const U8 g_LanguageEn[11];
//_STRINGSDEC_ const U8 g_DoubleSetStr[11];
//_STRINGSDEC_ const U8 g_DoubleSetStrEn[13];
//TRINGSDEC_ const U8 g_Ratio[11];
//TRINGSDEC_ const U8 g_RatioEn[16];
//TRINGSDEC_ const U8 g_NormalRatio[9];
//TRINGSDEC_ const U8 g_NormalRatioEn[13];
//TRINGSDEC_ const U8 g_4Ratio3[11];
//TRINGSDEC_ const U8 g_4Ratio3En[10];
//TRINGSDEC_ const U8 g_16Ratio9[11];
//TRINGSDEC_ const U8 g_16Ratio9En[11];
...
_STRINGSDEC_ const U8 g_Enterprise8724Str[21];
