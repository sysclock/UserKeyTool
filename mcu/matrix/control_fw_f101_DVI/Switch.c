...
//===2017,Jun 06 ; 15:8:30  ;BY YANG@BYCOX.COM===
//init m21121 when power up?
...
//===2017,Jun 06 ; 15:5:33  ;BY YANG@BYCOX.COM===
...
//===2017,Jun 06 ; 15:5:52  ;BY YANG@BYCOX.COM===   
...
//===2017,Jun 06 ; 15:7:31  ;BY YANG@BYCOX.COM===
void ChangePort(u8 Input,u8 Output)
{
 ...
 //===2017,Jun 06 ; 15:7:41  ;BY YANG@BYCOX.COM===
...
//===2017,Jun 06 ; 15:7:50  ;BY YANG@BYCOX.COM===
void InitDVI()
{
  u8 cTick;
  PowerUp211x1();
