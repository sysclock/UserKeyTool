...
//===2017,Jun 06 ; 16:21:23  ;BY YANG@BYCOX.COM===
//LCD display 
...
//===2017,Jun 06 ; 15:15:41  ;BY YANG@BYCOX.COM===
//initial switch chip:includes av\vga\dvi and hdmi
void InitSwitch(void)
{
    ...
    //  InitFm(); //初始化 FM6501
    //USART1->DR = 0xAA;	  DelayMs(50);
    // USART1->DR = 0x55;	  DelayMs(50);
    if(SysInfo.Type & TypeDVI)
    {
      InitDVI();  //初始化M21121
    }
