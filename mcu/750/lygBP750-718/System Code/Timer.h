...
//	SiI_9233_VIDEO_TMR,			// SiI9233 Video timer
	...
	SPI_10ms_TMR1,					// (4) IIC1 bus delay timer
									// ***** 100ms timer
...
#define NUM_10ms_TMR		5		// Number of 10ms timer
#define NUM_100ms_TMR		3		// Number of 100ms timer

extern volatile BYTE	gB_Count1ms;								// 1ms prescale counter
extern volatile BYTE gB_Count10ms;								// 10ms prescale counter
extern volatile unsigned short gB_Count100ms;			// 100ms prescale counter
extern volatile BYTE gBa_TmrBuf[MAX_TMR];				// Timer array
...
extern void TimerStart		(BYTE B_Timer, BYTE B_Value);
extern void TimerStop		(BYTE B_Timer);
extern BYTE TimerCheck		(BYTE B_Timer);
extern void Delay1ms		(BYTE B_Value);
extern void Delay10ms		(BYTE B_Value);
extern void Delay100ms		(BYTE B_Value);
