...
void Enable_SL38160(BYTE B_DeviceID);
void PowerDown_SL38160(BYTE B_DeviceID);
void Set_SL38160_CLK(BYTE B_DeviceID, BYTE audio_clk_num, BYTE video_clk_num);
BYTE SL38160_WriteByte	(BYTE B_DeviceID, BYTE B_Addr, BYTE B_Data);
BYTE I2C0_WriteBlock_SL38160_HIGH126(BYTE B_DeviceID, BYTE reg128, BYTE reg129);
/****************************************************************************/
...
/****************************************************************************/
/*                                                                          */
/* FUNCTION:    BYTE SL38160_WriteByte(BYTE B_DeviceID, WORD W_Addr, BYTE B_Data)			*/
/*                                                                          */
...
BYTE SL38160_WriteByte	(BYTE B_DeviceID, BYTE B_Addr, BYTE B_Data)
{
	BYTE i = 0;
	i = 0;
	while (I2C0WriteByte(B_DeviceID, B_Addr | 0x80, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &B_Data) == (BYTE) ERR)
	{
		Delay10ms(1);
		i++;
		if(i == 5)
...
BYTE I2C0_WriteBlock_SL38160_HIGH126(BYTE B_DeviceID, BYTE reg128, BYTE reg129)
{
	...
	B_Buf[8] = 0x7B;
	i = 0;
	while (I2C0WriteByte(B_DeviceID, 0xFE, I2C_DEV_MEMORY_ADDRESS_8BIT, 9, B_Buf) == (BYTE) ERR)
	{
		Delay10ms(1);
		i++;
		if(i == 5)
...
void Set_SL38160_CLK(BYTE B_DeviceID, BYTE audio_clk_num, BYTE video_clk_num)
{
	...
	I2C0_WriteBlock_SL38160_HIGH126(B_DeviceID, x, 0x81);
}
/****************************************************************************/
/*																			*/
