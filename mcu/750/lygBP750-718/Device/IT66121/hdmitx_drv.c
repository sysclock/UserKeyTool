...
// Function Prototype
//////////////////////////////////////////////////////////////////////
void hdmitx_LoadRegSetting(_CODE RegSetEntry table[]);

void HDMITX_InitTxDev(_CODE HDMITXDEV *pInstance)
{
	if(pInstance && 0 < HDMITX_MAX_DEV_COUNT)
	{
		// hdmiTxDev[0] = *pInstance ;
		memcpy(&(hdmiTxDev[0]), pInstance, sizeof(HDMITXDEV));
	}
}
...
{
    BYTE intdata1 = 0, intdata2 = 0, intdata3 = 0, sysstat = 0;
    BYTE  intclr3 = 0 ;
...
_CODE struct CRT_TimingSetting TimingTable[] =
{
    ...
    { 160, 800, 600,   1065, 628,   40,    128,   88,  1, 4,  23,      	 PROG, Vpos, Hpos},		// 800x600@60Hz       	- VESA Mode [160--HL Def]
    { 161,1024,  768,  1344, 	 806, 24,    	 136,  160,  3, 6,  29,      PROG, Vneg, Hneg},		// 1024x768@60Hz        - VESA Mode [161--HL Def]
    { 162,1366,  768,  1792, 	 798, 70,    	 143,  213,  3, 3,  24,      PROG, Vneg, Hneg},		// 1360x768@60Hz        - VESA Mode [162--HL Def]
    { 163,1400,  1050, 1864, 	 1089,88,    	 144,  232,  3, 4,  32,      PROG, Vpos, Hneg},		// 1400 x 1050@60Hz     - VESA Mode [163--HL Def]
		{0},
};
...
BOOL setHDMITX_SyncEmbeddedByVIC(BYTE VIC,BYTE bInputType)
{
    ...
    {
        int HTotal = 0, HDES = 0, VTotal = 0, VDES = 0;
        int HDEW = 0, VDEW = 0, HFP = 0, HSW = 0, VFP = 0, VSW = 0;
        int HRS = 0, HRE = 0;
        int VRS = 0, VRE = 0;
        int H2ndVRRise = 0;
        int VRS2nd = 0, VRE2nd = 0;
        BYTE Pol = 0;

				// Dummy Use
				VDES = VDES;	HDEW = HDEW;	VDEW = VDEW;
...
{
    BYTE AudioEnable = 0, AudioFormat = 0;
    BYTE i = 0;
