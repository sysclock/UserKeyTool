...
#define SUPPORT_EDID
#define SUPPORT_HDCP 						//HL Note
#define SUPPORT_SHA							//HL Note
...
#define SUPPORT_SYNCEMBEDDED						// HL Note
//#define SUPPORT_DEGEN
//#define NON_SEQUENTIAL_YCBCR422				// HL Note



//#define INPUT_COLOR_MODE F_MODE_RGB444			// HL Note
#define INPUT_COLOR_MODE F_MODE_YUV422				// HL Note
...
//#define OUTPUT_COLOR_MODE F_MODE_YUV444				// HL Note
#define OUTPUT_COLOR_MODE F_MODE_RGB444					// HL Note
...
// #define INV_INPUT_PCLK
    ...
    #define INPUT_SIGNAL_TYPE (T_MODE_SYNCEMB)                 // 16 bit sync embedded. --HL Note
    // #define INPUT_SIGNAL_TYPE (T_MODE_SYNCEMB | T_MODE_CCIR656) // 8 bit sync embedded
    // #define INPUT_SIGNAL_TYPE (T_MODE_SYNCEMB|T_MODE_INDDR|T_MODE_PCLKDIV2) // 16 bit sync embedded DDR. --HL Note
