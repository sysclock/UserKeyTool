...
{
	BYTE* pB_Data = NULL;
	if ((pB_Data = I2C0ReadByte(INPUT_FPGA_DEV, W_Addr, I2C_DEV_MEMORY_ADDRESS_16BIT, 1)) == NULL)
	{
		Delay10ms(1);
		if((pB_Data = I2C0ReadByte(INPUT_FPGA_DEV, W_Addr, I2C_DEV_MEMORY_ADDRESS_16BIT, 1)) == NULL)
		{
...
WORD InputFPGA_ReadWord(WORD W_Addr)
{
	BYTE* pB_Data = NULL;
	WORD W_Data;
	if ((pB_Data = I2C0ReadByte(INPUT_FPGA_DEV, W_Addr, I2C_DEV_MEMORY_ADDRESS_16BIT, 4)) == NULL)
	{
		Delay10ms(1);
		if((pB_Data = I2C0ReadByte(INPUT_FPGA_DEV, W_Addr, I2C_DEV_MEMORY_ADDRESS_16BIT, 4)) == NULL)
		{
...
{
	BYTE* pB_Data = NULL;
	if ((pB_Data = I2C0ReadByte(INPUT_FPGA_DEV, W_Addr, I2C_DEV_MEMORY_ADDRESS_16BIT, W_Len)) == NULL)
	{
		Delay10ms(1);
		if((pB_Data = I2C0ReadByte(INPUT_FPGA_DEV, W_Addr, I2C_DEV_MEMORY_ADDRESS_16BIT, W_Len)) == NULL)
		{
...
BYTE InputFPGA_WriteByte(WORD W_Addr, BYTE B_Data)
{
	BYTE i = 0;
	i = 0;
	while (I2C0WriteByte(INPUT_FPGA_DEV, W_Addr, I2C_DEV_MEMORY_ADDRESS_16BIT, 1, &B_Data) == ((BYTE) ERR))
	{
		Delay10ms(1);
		i++;
		if(i == 5)
...
BYTE InputFPGA_WriteWord(WORD W_Addr, WORD W_Data)
{
	...
	i = 0;
	while (I2C0WriteByte(INPUT_FPGA_DEV, W_Addr, I2C_DEV_MEMORY_ADDRESS_16BIT, 4, B_Data) == ((BYTE) ERR))
	{
		Delay10ms(1);
		i++;
		if(i == 5)
...
{
	BYTE i = 0;
	while (I2C0WriteByte(INPUT_FPGA_DEV, W_Addr, I2C_DEV_MEMORY_ADDRESS_16BIT, W_Len, Bp_Buf) == ((BYTE) ERR))
	{
		Delay10ms(1);
		i++;
		if(i == 5)
