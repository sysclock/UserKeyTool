...
#define CONF__OUTPUT_VIDEO_FORMAT       (VAL__YC422_MUX_8BIT_EMBED_SYNC)
...
// Debug Options
#define CONF__DEBUG_PRINT               (ENABLE)    	//print debug messages
//#define CONF__DEBUG_CMD_HANDLER         (ENABLE)    //run debug command handler
#define CONF__DEBUG_CMD_HANDLER         (DISABLE)    	//not run debug command handler
...
#define CONF__CEC_ENABLE (ENABLE)
