...
const LUT_CEC_EVENT_HANDLER CEC_RX_REPLY_LUT[] =
{
  /*
   ========================= ==========================
...
const uint8_t abEnumTblTV[3]  = { 2, SiI_CEC_LogAddr_TV,   SiI_CEC_LogAddr_FreeUse };
const uint8_t abEnumTblDVD[4] = { 3, SiI_CEC_LogAddr_DVD1, SiI_CEC_LogAddr_DVD2, SiI_CEC_LogAddr_FreeUse };
//------------------------------------------------------------------------------
// Function Name:
...
const LUT_CEC_MSG_INFO CEC_RX_MSG_LUT[] =
{
  /*
   ====== ========  ===============         ==========================
...
/****************************************************************************/
/*																			*/
/* FUNCTION:    CEC__DummyCall(void)                                       	*/
/*																			*/
/* USAGE:       To get by the data overlay problem when function is not     */
/*				being called.												*/
/*																			*/
/****************************************************************************/
void CEC_DummyCall(void)
{
#if(CONF__CEC_ENABLE == ENABLE)
	TV_state = TV_state;
	memset(&cec_event_dscrptr, 0, sizeof(cec_event_dscrptr));
#endif
}
