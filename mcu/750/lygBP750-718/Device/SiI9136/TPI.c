...
*/
	...
	B_Data = 0x14;
	I2C0WriteByte(TPI_BASE_ADDR, 0x7C, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &B_Data);					// HW debounce to 64ms (0x14)
#ifdef F_9136
	B_Data = 0xA5;
	I2C0WriteByte(TPI_BASE_ADDR, 0x82, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &B_Data);
#endif
}
