...
{
	byte *pData = NULL;
	pData = I2C0ReadByte(TX_SLAVE_ADDR, RegOffset, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	return *pData;
...
{
	I2C0WriteByte(TPI_BASE_ADDR, RegOffset, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &Data);
...
{
 	byte *Bp_Data = NULL;
	Bp_Data = I2C0ReadByte(TPI_BASE_ADDR, TPI_Offset, I2C_DEV_MEMORY_ADDRESS_8BIT, NBytes);
...
{
	I2C0WriteByte(TPI_BASE_ADDR, TPI_Offset, I2C_DEV_MEMORY_ADDRESS_8BIT, NBytes, pData);
...
byte ReadByteCBUS (byte Offset) {
	byte *pData = NULL;
	pData = I2C0ReadByte(CBUS_SLAVE_ADDR, Offset, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	return *pData;
//	return I2C_ReadByte(CBUS_SLAVE_ADDR, Offset);
	}

void WriteByteCBUS(byte Offset, byte Data) {
	I2C0WriteByte(CBUS_SLAVE_ADDR, Offset, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &Data);
