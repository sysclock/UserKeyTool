...
//		while(i == 3)
		...
		if(B_Data == TRUE)
		{
			...
			Stp_TempDeviceSiI9136->B_BoardIndex = i;
...
//					Stp_TempVideoModeDescription->HDCPAuthenticated = VMD_HDCP_AUTHENTICATED;
			...
			TPI_TRACE_PRINT(("Board %d , Output %d , Begin Init.\r\n", Stp_TempDeviceSiI9136->B_BoardIndex, Stp_TempDeviceSiI9136->B_SubI2CBusIndex));
			TPI_Init();
			...
			TPI_TRACE_PRINT(("Board %d , Output %d , Init Ok.\r\n", Stp_TempDeviceSiI9136->B_BoardIndex, Stp_TempDeviceSiI9136->B_SubI2CBusIndex));
			printf("Board %d , Output %d , SiI9136 Init OK\r\n", Stp_TempDeviceSiI9136->B_BoardIndex, Stp_TempDeviceSiI9136->B_SubI2CBusIndex);
		}
	}
