...
#ifdef USE_51_I2CIO
	SYS_STATUS flag;
	flag = (SYS_STATUS) i2c_write_byte(I2CADR, RegAddr, 1, &d, I2CDEV);
...
#ifdef USE_51_I2CIO
	BOOL flag;
	flag = (SYS_STATUS) i2c_read_byte(I2CADR, RegAddr, N, pData, I2CDEV);
	return (SYS_STATUS) !flag;
#else
...
SYS_STATUS WriteI2C_ByteN(BYTE RegAddr, cBYTE *pData, int N)
{
	...
	flag = (SYS_STATUS) i2c_write_byte(I2CADR, RegAddr++, N, I2C_buf, I2CDEV);
	return (SYS_STATUS) !flag;
#else
	BYTE I2C_buf[18];
	int     i;
