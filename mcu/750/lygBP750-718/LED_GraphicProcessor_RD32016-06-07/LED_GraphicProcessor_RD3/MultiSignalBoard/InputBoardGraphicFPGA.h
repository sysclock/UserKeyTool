...
#define	MaxOneInputBoardDisplayPortNum				4
...
#define			INPUT_BOARD_VDPG											0x56445047
#define			INPUT_BOARD_VDPH											0x56445048
#define			INPUT_BOARD_VDPI											0x56445049
#define			INPUT_BOARD_VDPJ											0x5644504A
