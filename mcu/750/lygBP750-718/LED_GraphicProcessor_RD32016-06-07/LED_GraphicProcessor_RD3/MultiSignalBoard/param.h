...
//	NVR_MODE=MEM_EEPROM + MEM_EEPROM_OFFSET,									// mode
	...
	NVR_TCP_MYIP_1,													// IP Address MYIP_1
	NVR_TCP_MYIP_2,													// IP Address MYIP_2
	NVR_TCP_MYIP_3,													// IP Address MYIP_3
	NVR_TCP_MYIP_4,													// IP Address MYIP_4
	NVR_TCP_SUBMASK_1,											// IP Address SUBMASK_1
	NVR_TCP_SUBMASK_2,											// IP Address SUBMASK_2
	NVR_TCP_SUBMASK_3,											// IP Address SUBMASK_3
	NVR_TCP_SUBMASK_4,											// IP Address SUBMASK_4
	NVR_TCP_GWIP_1,													// IP Address Standard Gateway GWIP_1
	NVR_TCP_GWIP_2,													// IP Address Standard Gateway GWIP_2
	NVR_TCP_GWIP_3,													// IP Address Standard Gateway GWIP_3
	NVR_TCP_GWIP_4,													// IP Address Standard Gateway GWIP_4
	NVR_TCP_LOCAL_PORT,											// TCP port we want to listen to
...
extern void	BoardParamTCPInit (void);
#endif
