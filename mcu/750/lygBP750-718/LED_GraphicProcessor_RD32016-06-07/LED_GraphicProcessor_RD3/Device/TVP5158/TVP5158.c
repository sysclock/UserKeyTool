...
WORD TVP5158_ReadByte(BYTE B_ChipIndex, BYTE B_Addr)
{
	...
	switch (B_ChipIndex)
	{
		...
		*/
		case TVP5158_DEV2:
			if ((pB_Data = I2C1ReadByte(TVP5158_I2C_ADD_DEV2, B_Addr, I2C_DEV_MEMORY_ADDRESS_8BIT, 1)) == NULL)
			{
				Delay10ms(1);
				if((pB_Data = I2C1ReadByte(TVP5158_I2C_ADD_DEV2, B_Addr, I2C_DEV_MEMORY_ADDRESS_8BIT, 1)) == NULL)
				{
			...
			break;
		case TVP5158_DEV3:
			if ((pB_Data = I2C1ReadByte(TVP5158_I2C_ADD_DEV3, B_Addr, I2C_DEV_MEMORY_ADDRESS_8BIT, 1)) == NULL)
			{
				Delay10ms(1);
				if((pB_Data = I2C1ReadByte(TVP5158_I2C_ADD_DEV3, B_Addr, I2C_DEV_MEMORY_ADDRESS_8BIT, 1)) == NULL)
				{
			...
			break;
		case TVP5158_DEV4:
			if ((pB_Data = I2C1ReadByte(TVP5158_I2C_ADD_DEV4, B_Addr, I2C_DEV_MEMORY_ADDRESS_8BIT, 1)) == NULL)
			{
				Delay10ms(1);
				if((pB_Data = I2C1ReadByte(TVP5158_I2C_ADD_DEV4, B_Addr, I2C_DEV_MEMORY_ADDRESS_8BIT, 1)) == NULL)
				{
			...
			break;
		case TVP5158_DEV5:
			if ((pB_Data = I2C1ReadByte(TVP5158_I2C_ADD_DEV5, B_Addr, I2C_DEV_MEMORY_ADDRESS_8BIT, 1)) == NULL)
			{
				Delay10ms(1);
				if((pB_Data = I2C1ReadByte(TVP5158_I2C_ADD_DEV5, B_Addr, I2C_DEV_MEMORY_ADDRESS_8BIT, 1)) == NULL)
				{
...
BYTE TVP5158_WriteByte (BYTE B_ChipIndex, BYTE B_Addr, BYTE B_Data)
{
	...
	switch (B_ChipIndex)
	{
		...
		*/
		case TVP5158_DEV2:
			i = 0;
			while (I2C1WriteByte(TVP5158_I2C_ADD_DEV2, B_Addr, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &B_Data) == (BYTE) ERR)
			{
				Delay10ms(1);
				i++;
				if(i == 5)
		...
		case TVP5158_DEV3:
			i = 0;
			while (I2C1WriteByte(TVP5158_I2C_ADD_DEV3, B_Addr, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &B_Data) == (BYTE) ERR)
			{
				Delay10ms(1);
				i++;
				if(i == 5)
		...
		case TVP5158_DEV4:
			i = 0;
			while (I2C1WriteByte(TVP5158_I2C_ADD_DEV4, B_Addr, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &B_Data) == (BYTE) ERR)
			{
				Delay10ms(1);
				i++;
				if(i == 5)
		...
		case TVP5158_DEV5:
			i = 0;
			while (I2C1WriteByte(TVP5158_I2C_ADD_DEV5, B_Addr, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &B_Data) == (BYTE) ERR)
			{
				Delay10ms(1);
				i++;
				if(i == 5)
...
BYTE TVP5158_WriteData(BYTE B_ChipIndex, BYTE B_Addr, BYTE *Bp_Buf, BYTE B_Len)
{
	...
	switch (B_ChipIndex)
	{
		...
		*/
		case TVP5158_DEV2:
			i = 0;
			while (I2C1WriteByte(TVP5158_I2C_ADD_DEV2, B_Addr, I2C_DEV_MEMORY_ADDRESS_8BIT, B_Len, Bp_Buf) == (BYTE) ERR)
			{
				Delay10ms(1);
				i++;
				if(i == 5)
		...
		case TVP5158_DEV3:
			i = 0;
			while (I2C1WriteByte(TVP5158_I2C_ADD_DEV3, B_Addr, I2C_DEV_MEMORY_ADDRESS_8BIT, B_Len, Bp_Buf) == (BYTE) ERR)
			{
				Delay10ms(1);
				i++;
				if(i == 5)
		...
		case TVP5158_DEV4:
			i = 0;
			while (I2C1WriteByte(TVP5158_I2C_ADD_DEV4, B_Addr, I2C_DEV_MEMORY_ADDRESS_8BIT, B_Len, Bp_Buf) == (BYTE) ERR)
			{
				Delay10ms(1);
				i++;
				if(i == 5)
		...
		case TVP5158_DEV5:
			i = 0;
			while (I2C1WriteByte(TVP5158_I2C_ADD_DEV5, B_Addr, I2C_DEV_MEMORY_ADDRESS_8BIT, B_Len, Bp_Buf) == (BYTE) ERR)
			{
				Delay10ms(1);
				i++;
				if(i == 5)
