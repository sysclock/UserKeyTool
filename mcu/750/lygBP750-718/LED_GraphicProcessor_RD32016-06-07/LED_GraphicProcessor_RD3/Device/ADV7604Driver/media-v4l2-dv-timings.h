...
#include "../ADV7604Driver/videodev2.h"
 ...
 */
typedef unsigned char v4l2_check_dv_timings_fnc(const struct v4l2_dv_timings *t, void *handle);
...
/** v4l2_valid_dv_timings() - are these timings valid?
  ...
  * false otherwise.
  */
extern unsigned char v4l2_valid_dv_timings(const struct v4l2_dv_timings *t,
...
/** v4l2_find_dv_timings_cap() - Find the closest timings struct
  ...
  */
extern unsigned char v4l2_find_dv_timings_cap(struct v4l2_dv_timings *t,
                              const struct v4l2_dv_timings_cap *cap,
...
/** v4l2_match_dv_timings() - do two timings match?
  ...
  */
extern unsigned char v4l2_match_dv_timings(const struct v4l2_dv_timings *measured,
 ...
 */
extern unsigned char v4l2_detect_cvt(unsigned frame_height, unsigned hfreq, unsigned vsync,
 ...
 */
extern unsigned char v4l2_detect_gtf(unsigned frame_height, unsigned hfreq, unsigned vsync,
                unsigned long polarities, struct v4l2_fract aspect,
 ...
 */
extern struct v4l2_fract v4l2_calc_aspect_ratio(unsigned char hor_landscape, unsigned char vert_portrait);
