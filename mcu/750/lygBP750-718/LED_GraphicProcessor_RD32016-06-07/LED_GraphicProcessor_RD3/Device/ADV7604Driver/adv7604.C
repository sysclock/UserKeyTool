...
//        struct i2c_client *client = v4l2_get_subdevdata(sd);
        ...
        case ADV7604_MODE_GR:
                ...
                /* IO-map reg. 0x16 and 0x17 should be written in sequence */
								Stp_ADV7604_platform_pdata = &(state->pdata);
								if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
								{
									if (I2C1WriteByte(ADV7604_SLAVE_ADDR, 0x16, I2C_DEV_MEMORY_ADDRESS_8BIT, 2, pll) == (BYTE) ERR)
									{
								...
								{
									if (I2C2WriteByte(ADV7604_SLAVE_ADDR, 0x16, I2C_DEV_MEMORY_ADDRESS_8BIT, 2, pll) == (BYTE) ERR)
									{
													printf("%s writing to reg 0x16 and 0x17 failed\r\n", __func__);
													break;
									}
...
static unsigned char io_read(struct adv7604_state *state, unsigned char reg)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		aByte = I2C1ReadByte(ADV7604_SLAVE_ADDR, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	else
		aByte = I2C2ReadByte(ADV7604_SLAVE_ADDR, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char io_write(struct adv7604_state *state, unsigned char reg, unsigned char val)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		Ret = I2C1WriteByte(ADV7604_SLAVE_ADDR, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	else
		Ret = I2C2WriteByte(ADV7604_SLAVE_ADDR, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char avlink_read(struct adv7604_state *state, unsigned char reg)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		aByte = I2C1ReadByte(Stp_ADV7604_platform_pdata->i2c_avlink, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	else
		aByte = I2C2ReadByte(Stp_ADV7604_platform_pdata->i2c_avlink, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char avlink_write(struct adv7604_state *state, unsigned char reg, unsigned char val)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		Ret = I2C1WriteByte(Stp_ADV7604_platform_pdata->i2c_avlink, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	else
		Ret = I2C2WriteByte(Stp_ADV7604_platform_pdata->i2c_avlink, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char cec_read(struct adv7604_state *state, unsigned char reg)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		aByte = I2C1ReadByte(Stp_ADV7604_platform_pdata->i2c_cec, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	else
		aByte = I2C2ReadByte(Stp_ADV7604_platform_pdata->i2c_cec, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char cec_write(struct adv7604_state *state, unsigned char reg, unsigned char val)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		Ret = I2C1WriteByte(Stp_ADV7604_platform_pdata->i2c_cec, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	else
		Ret = I2C2WriteByte(Stp_ADV7604_platform_pdata->i2c_cec, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char infoframe_read(struct adv7604_state *state, unsigned char reg)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		aByte = I2C1ReadByte(Stp_ADV7604_platform_pdata->i2c_infoframe, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	else
		aByte = I2C2ReadByte(Stp_ADV7604_platform_pdata->i2c_infoframe, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char infoframe_write(struct adv7604_state *state, unsigned char reg, unsigned char val)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		Ret = I2C1WriteByte(Stp_ADV7604_platform_pdata->i2c_infoframe, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	else
		Ret = I2C2WriteByte(Stp_ADV7604_platform_pdata->i2c_infoframe, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char esdp_read(struct adv7604_state *state, unsigned char reg)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		aByte = I2C1ReadByte(Stp_ADV7604_platform_pdata->i2c_esdp, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	else
		aByte = I2C2ReadByte(Stp_ADV7604_platform_pdata->i2c_esdp, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char esdp_write(struct adv7604_state *state, unsigned char reg, unsigned char val)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		Ret = I2C1WriteByte(Stp_ADV7604_platform_pdata->i2c_esdp, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	else
		Ret = I2C2WriteByte(Stp_ADV7604_platform_pdata->i2c_esdp, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char dpp_read(struct adv7604_state *state, unsigned char reg)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		aByte = I2C1ReadByte(Stp_ADV7604_platform_pdata->i2c_dpp, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	else
		aByte = I2C2ReadByte(Stp_ADV7604_platform_pdata->i2c_dpp, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char dpp_write(struct adv7604_state *state, unsigned char reg, unsigned char val)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		Ret = I2C1WriteByte(Stp_ADV7604_platform_pdata->i2c_dpp, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	else
		Ret = I2C2WriteByte(Stp_ADV7604_platform_pdata->i2c_dpp, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char afe_read(struct adv7604_state *state, unsigned char reg)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		aByte = I2C1ReadByte(Stp_ADV7604_platform_pdata->i2c_afe, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	else
		aByte = I2C2ReadByte(Stp_ADV7604_platform_pdata->i2c_afe, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char afe_write(struct adv7604_state *state, unsigned char reg, unsigned char val)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		Ret = I2C1WriteByte(Stp_ADV7604_platform_pdata->i2c_afe, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	else
		Ret = I2C2WriteByte(Stp_ADV7604_platform_pdata->i2c_afe, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char rep_read(struct adv7604_state *state, unsigned char reg)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		aByte = I2C1ReadByte(Stp_ADV7604_platform_pdata->i2c_repeater, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	else
		aByte = I2C2ReadByte(Stp_ADV7604_platform_pdata->i2c_repeater, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char rep_write(struct adv7604_state *state, unsigned char reg, unsigned char val)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		Ret = I2C1WriteByte(Stp_ADV7604_platform_pdata->i2c_repeater, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	else
		Ret = I2C2WriteByte(Stp_ADV7604_platform_pdata->i2c_repeater, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char edid_read(struct adv7604_state *state, unsigned char reg)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		aByte = I2C1ReadByte(Stp_ADV7604_platform_pdata->i2c_edid, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	else
		aByte = I2C2ReadByte(Stp_ADV7604_platform_pdata->i2c_edid, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char edid_write(struct adv7604_state *state, unsigned char reg, unsigned char val)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		Ret = I2C1WriteByte(Stp_ADV7604_platform_pdata->i2c_edid, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	else
		Ret = I2C2WriteByte(Stp_ADV7604_platform_pdata->i2c_edid, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char hdmi_read(struct adv7604_state *state, unsigned char reg)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		aByte = I2C1ReadByte(Stp_ADV7604_platform_pdata->i2c_hdmi, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	else
		aByte = I2C2ReadByte(Stp_ADV7604_platform_pdata->i2c_hdmi, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char hdmi_write(struct adv7604_state *state, unsigned char reg, unsigned char val)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		Ret = I2C1WriteByte(Stp_ADV7604_platform_pdata->i2c_hdmi, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	else
		Ret = I2C2WriteByte(Stp_ADV7604_platform_pdata->i2c_hdmi, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char test_read(struct adv7604_state *state, unsigned char reg)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		aByte = I2C1ReadByte(Stp_ADV7604_platform_pdata->i2c_test, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	else
		aByte = I2C2ReadByte(Stp_ADV7604_platform_pdata->i2c_test, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char test_write(struct adv7604_state *state, unsigned char reg, unsigned char val)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		Ret = I2C1WriteByte(Stp_ADV7604_platform_pdata->i2c_test, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	else
		Ret = I2C2WriteByte(Stp_ADV7604_platform_pdata->i2c_test, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char cp_read(struct adv7604_state *state, unsigned char reg)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		aByte = I2C1ReadByte(Stp_ADV7604_platform_pdata->i2c_cp, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	else
		aByte = I2C2ReadByte(Stp_ADV7604_platform_pdata->i2c_cp, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char cp_write(struct adv7604_state *state, unsigned char reg, unsigned char val)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		Ret = I2C1WriteByte(Stp_ADV7604_platform_pdata->i2c_cp, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	else
		Ret = I2C2WriteByte(Stp_ADV7604_platform_pdata->i2c_cp, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char vdp_read(struct adv7604_state *state, unsigned char reg)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		aByte = I2C1ReadByte(Stp_ADV7604_platform_pdata->i2c_vdp, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	else
		aByte = I2C2ReadByte(Stp_ADV7604_platform_pdata->i2c_vdp, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1);
	#if(ADV7604_DEBUG == 2)
...
static unsigned char vdp_write(struct adv7604_state *state, unsigned char reg, unsigned char val)
{
	...
	Stp_ADV7604_platform_pdata = &(state->pdata);
	if(Stp_ADV7604_platform_pdata->i2c_busindex == 0)
		Ret = I2C1WriteByte(Stp_ADV7604_platform_pdata->i2c_vdp, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	else
		Ret = I2C2WriteByte(Stp_ADV7604_platform_pdata->i2c_vdp, reg, I2C_DEV_MEMORY_ADDRESS_8BIT, 1, &val);
	#if(ADV7604_DEBUG == 2)
...
static void ADV7604_WriteInternalEdid(struct adv7604_state *state, unsigned char EdidMode)
{
	...
	else if(EdidMode == 3)
	{
		...
		edid_write(state, 0x06, 0xFF);
		edid_write(state, 0x07, 0x00);
		edid_write(state, 0x08, 0x36);
		edid_write(state, 0x09, 0x74);
		edid_write(state, 0x0A, 0x30);
		edid_write(state, 0x0B, 0x00);
		edid_write(state, 0x0C, 0x01);
		edid_write(state, 0x0D, 0x00);
		edid_write(state, 0x0E, 0x00);
		edid_write(state, 0x0F, 0x00);
		edid_write(state, 0x10, 0x0A);
		edid_write(state, 0x11, 0x16);
		edid_write(state, 0x12, 0x01);
		edid_write(state, 0x13, 0x03);
		edid_write(state, 0x14, 0x80);
		edid_write(state, 0x15, 0x73);
		edid_write(state, 0x16, 0x41);
		edid_write(state, 0x17, 0x78);
		edid_write(state, 0x18, 0x0A);
		edid_write(state, 0x19, 0xCF);
		edid_write(state, 0x1A, 0x74);
		edid_write(state, 0x1B, 0xA3);
		edid_write(state, 0x1C, 0x57);
		edid_write(state, 0x1D, 0x4C);
		edid_write(state, 0x1E, 0xB0);
		edid_write(state, 0x1F, 0x23);
		edid_write(state, 0x20, 0x09);
		edid_write(state, 0x21, 0x48);
		edid_write(state, 0x22, 0x4C);
		edid_write(state, 0x23, 0x21);
		edid_write(state, 0x24, 0x08);
		edid_write(state, 0x25, 0x00);
		edid_write(state, 0x26, 0x81);
		edid_write(state, 0x27, 0x80);
		edid_write(state, 0x28, 0x45);
		edid_write(state, 0x29, 0x40);
		edid_write(state, 0x2A, 0x61);
		edid_write(state, 0x2B, 0x40);
		edid_write(state, 0x2C, 0x95);
		edid_write(state, 0x2D, 0x00);
		edid_write(state, 0x2E, 0x01);
		edid_write(state, 0x2F, 0x01);
		...
		edid_write(state, 0x40, 0x45);
		edid_write(state, 0x41, 0x00);
		edid_write(state, 0x42, 0xC4);
		edid_write(state, 0x43, 0x8E);
		edid_write(state, 0x44, 0x21);
		edid_write(state, 0x45, 0x00);
		edid_write(state, 0x46, 0x00);
		edid_write(state, 0x47, 0x1E);
		edid_write(state, 0x48, 0x66);
		edid_write(state, 0x49, 0x21);
		edid_write(state, 0x4A, 0x50);
		edid_write(state, 0x4B, 0xB0);
		edid_write(state, 0x4C, 0x51);
		edid_write(state, 0x4D, 0x00);
		edid_write(state, 0x4E, 0x1B);
		edid_write(state, 0x4F, 0x30);
		edid_write(state, 0x50, 0x40);
		edid_write(state, 0x51, 0x70);
		edid_write(state, 0x52, 0x36);
		edid_write(state, 0x53, 0x00);
		edid_write(state, 0x54, 0xC4);
		edid_write(state, 0x55, 0x8E);
		edid_write(state, 0x56, 0x21);
		edid_write(state, 0x57, 0x00);
		edid_write(state, 0x58, 0x00);
		edid_write(state, 0x59, 0x1E);
		edid_write(state, 0x5A, 0x00);
		edid_write(state, 0x5B, 0x00);
		edid_write(state, 0x5C, 0x00);
		edid_write(state, 0x5D, 0xFC);
		edid_write(state, 0x5E, 0x00);
		edid_write(state, 0x5F, 0x4D);
		edid_write(state, 0x60, 0x53);
		edid_write(state, 0x61, 0x74);
		edid_write(state, 0x62, 0x61);
		edid_write(state, 0x63, 0x72);
		edid_write(state, 0x64, 0x20);
		edid_write(state, 0x65, 0x44);
		edid_write(state, 0x66, 0x65);
		edid_write(state, 0x67, 0x6D);
		edid_write(state, 0x68, 0x6F);
		edid_write(state, 0x69, 0x0A);
		edid_write(state, 0x6A, 0x20);
		edid_write(state, 0x6B, 0x20);
		edid_write(state, 0x6C, 0x00);
		edid_write(state, 0x6D, 0x00);
		...
		edid_write(state, 0x6F, 0xFD);
		edid_write(state, 0x70, 0x00);
		edid_write(state, 0x71, 0x32);
		edid_write(state, 0x72, 0x4B);
		edid_write(state, 0x73, 0x1E);
		edid_write(state, 0x74, 0x50);
		edid_write(state, 0x75, 0x17);
		edid_write(state, 0x76, 0x00);
		edid_write(state, 0x77, 0x0A);
		edid_write(state, 0x78, 0x20);
		edid_write(state, 0x79, 0x20);
		...
		edid_write(state, 0x7D, 0x20);
		edid_write(state, 0x7E, 0x01);
		edid_write(state, 0x7F, 0xF1);
		edid_write(state, 0x80, 0x02);
		edid_write(state, 0x81, 0x03);
		edid_write(state, 0x82, 0x30);
		edid_write(state, 0x83, 0xF2);
		edid_write(state, 0x84, 0x4D);
		edid_write(state, 0x85, 0x01);
		edid_write(state, 0x86, 0x03);
		edid_write(state, 0x87, 0x04);
		edid_write(state, 0x88, 0x05);
		edid_write(state, 0x89, 0x07);
		edid_write(state, 0x8A, 0x90);
		edid_write(state, 0x8B, 0x12);
		edid_write(state, 0x8C, 0x13);
		edid_write(state, 0x8D, 0x14);
		edid_write(state, 0x8E, 0x16);
		edid_write(state, 0x8F, 0x9F);
		edid_write(state, 0x90, 0x20);
		edid_write(state, 0x91, 0x22);
		edid_write(state, 0x92, 0x26);
		edid_write(state, 0x93, 0x09);
		edid_write(state, 0x94, 0x07);
		edid_write(state, 0x95, 0x07);
		edid_write(state, 0x96, 0x11);
		edid_write(state, 0x97, 0x17);
		edid_write(state, 0x98, 0x50);
		edid_write(state, 0x99, 0x83);
		edid_write(state, 0x9A, 0x01);
		edid_write(state, 0x9B, 0x00);
		edid_write(state, 0x9C, 0x00);
		edid_write(state, 0x9D, 0x72);
		edid_write(state, 0x9E, 0x03);
		edid_write(state, 0x9F, 0x0C);
		edid_write(state, 0xA0, 0x00);
		edid_write(state, 0xA1, 0x10);
		edid_write(state, 0xA2, 0x00);
		edid_write(state, 0xA3, 0xB8);
		edid_write(state, 0xA4, 0x44);
		edid_write(state, 0xA5, 0x20);
		edid_write(state, 0xA6, 0xC0);
		edid_write(state, 0xA7, 0x84);
		edid_write(state, 0xA8, 0x01);
		edid_write(state, 0xA9, 0x02);
		edid_write(state, 0xAA, 0x03);
		edid_write(state, 0xAB, 0x04);
		edid_write(state, 0xAC, 0x01);
		edid_write(state, 0xAD, 0x41);
		edid_write(state, 0xAE, 0x00);
		edid_write(state, 0xAF, 0x00);
		edid_write(state, 0xB0, 0x8C);
		edid_write(state, 0xB1, 0x0A);
		edid_write(state, 0xB2, 0xD0);
		edid_write(state, 0xB3, 0x8A);
		edid_write(state, 0xB4, 0x20);
		edid_write(state, 0xB5, 0xE0);
		edid_write(state, 0xB6, 0x2D);
		edid_write(state, 0xB7, 0x10);
		edid_write(state, 0xB8, 0x10);
		edid_write(state, 0xB9, 0x3E);
		edid_write(state, 0xBA, 0x96);
		edid_write(state, 0xBB, 0x00);
		edid_write(state, 0xBC, 0xC4);
		edid_write(state, 0xBD, 0x8E);
		edid_write(state, 0xBE, 0x21);
		edid_write(state, 0xBF, 0x00);
		edid_write(state, 0xC0, 0x00);
		edid_write(state, 0xC1, 0x18);
		edid_write(state, 0xC2, 0x8C);
		edid_write(state, 0xC3, 0x0A);
		edid_write(state, 0xC4, 0xD0);
		edid_write(state, 0xC5, 0x90);
		edid_write(state, 0xC6, 0x20);
		edid_write(state, 0xC7, 0x40);
		edid_write(state, 0xC8, 0x31);
		edid_write(state, 0xC9, 0x20);
		edid_write(state, 0xCA, 0x0C);
		edid_write(state, 0xCB, 0x40);
		edid_write(state, 0xCC, 0x55);
		edid_write(state, 0xCD, 0x00);
		edid_write(state, 0xCE, 0xC4);
		edid_write(state, 0xCF, 0x8E);
		edid_write(state, 0xD0, 0x21);
		edid_write(state, 0xD1, 0x00);
		edid_write(state, 0xD2, 0x00);
		edid_write(state, 0xD3, 0x18);
		edid_write(state, 0xD4, 0x01);
		edid_write(state, 0xD5, 0x1D);
		edid_write(state, 0xD6, 0x00);
		edid_write(state, 0xD7, 0xBC);
		edid_write(state, 0xD8, 0x52);
		edid_write(state, 0xD9, 0xD0);
		edid_write(state, 0xDA, 0x1E);
		edid_write(state, 0xDB, 0x20);
		edid_write(state, 0xDC, 0xB8);
		edid_write(state, 0xDD, 0x28);
		edid_write(state, 0xDE, 0x55);
		edid_write(state, 0xDF, 0x40);
		edid_write(state, 0xE0, 0xC4);
		edid_write(state, 0xE1, 0x8E);
		edid_write(state, 0xE2, 0x21);
		edid_write(state, 0xE3, 0x00);
		edid_write(state, 0xE4, 0x00);
		edid_write(state, 0xE5, 0x1E);
		edid_write(state, 0xE6, 0x01);
		edid_write(state, 0xE7, 0x1D);
		edid_write(state, 0xE8, 0x80);
		edid_write(state, 0xE9, 0xD0);
		edid_write(state, 0xEA, 0x72);
		edid_write(state, 0xEB, 0x1C);
		edid_write(state, 0xEC, 0x16);
		edid_write(state, 0xED, 0x20);
		edid_write(state, 0xEE, 0x10);
		edid_write(state, 0xEF, 0x2C);
		edid_write(state, 0xF0, 0x25);
		edid_write(state, 0xF1, 0x80);
		edid_write(state, 0xF2, 0xC4);
		edid_write(state, 0xF3, 0x8E);
		edid_write(state, 0xF4, 0x21);
		edid_write(state, 0xF5, 0x00);
		edid_write(state, 0xF6, 0x00);
		edid_write(state, 0xF7, 0x9E);
		edid_write(state, 0xF8, 0x00);
		edid_write(state, 0xF9, 0x00);
		edid_write(state, 0xFA, 0x00);
		edid_write(state, 0xFB, 0x00);
