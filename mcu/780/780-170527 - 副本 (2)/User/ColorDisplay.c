...
// 					{
	...
	switch(CurState)
	{
		...
		case State_MainMenu_Menu_InOutput:
			...
			InSrcRes[0].resolution_width,InSrcRes[0].resolution_high,
			InSrcRes[1].resolution_width,InSrcRes[1].resolution_high,
			InSrcRes[2].resolution_width,InSrcRes[2].resolution_high,
			InSrcRes[3].resolution_width,InSrcRes[3].resolution_high);
			GpuSend(GpuBuf);
				delay_ms(80);
			LCD_UI_NO=101;
			break;
...
//					break;	
		...
		case State_WizardSet_InputSource_Set:
		{
				...
				GpuSend(GpuBuf);
				if(InSrcRes[0].resolution_width!=0)
				{
					GpuSend("SBC(5);");
				...
				if(InSrcRes[1].resolution_width!=0)
				{
					GpuSend("SBC(5);");
				...
				if(InSrcRes[2].resolution_width!=0)
				{
					GpuSend("SBC(5);");
				...
				if(InSrcRes[3].resolution_width!=0)
				{
					GpuSend("SBC(5);");
