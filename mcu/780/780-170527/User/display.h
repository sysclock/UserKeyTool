...
#define IN_PORT_NUM_OF_1CARD 4
#define OUT_PORT_NUM_OF_1CARD 4
...
#define MAT_MOD_0vs0 0
#define MAT_MOD_0vsM 1
#define MAT_MOD_NvsM 2
#define MAT_MOD_Nvs0 3



#define RES_InIMGLOST 0
#define RES_OutLarge 1
#define RES_InLarge 	2
#define RES_InEQOut 	3
#define RES_NOTCOMP 4
...
extern Resolution_Data InSrcRes[IN_PORT_NUM];
...
//Add_New_Image(),Matrix_Display_Function-->image_layout_Para_Process-->OutFPGA_Scaler_Para_Process,IF_directTo_OF_AddWin_Para_Process
...
void inImag_direct_to_out_OF_AW(AW_BG_No,source_to_outboard_num,i);	
