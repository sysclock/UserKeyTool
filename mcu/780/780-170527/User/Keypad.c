...
//scan and echo ir remote operation
void Scan_Deal_IR(void)
{
...
//			}	
	...
	if(g_LockKeyFlag==UNLOCKKEYPAD)
	{
		if(flag==1)
		{
			...
			{
				LCD_BACK_NUM=100;	
				set_lcd_backLight(LCD_BACK_NUM);			
			}
...
StateData stateData[]=
{
	...
	//State_ScreenSet_OutPort_Num,
	{
		...
		NULL,NULL,&LcdDisp_BackGround_Graph
	},
...
//			State_AdvancePara_UserPara
	...
	//State_User_Set_TelNumber
	{
		...
		{State_User_Set_TelNumber,   //up
			...
			State_DebugMode_Start},&DirectSetValue,
		NULL,NULL,&LcdDisp_BackGround_Graph
	},
	//State_User_Set_TechSupport_PhoneNumber++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	{
		...
		0x91,"_","_",
		{State_User_Set_TechSupport_PhoneNumber,   //up
			State_User_Set_TechSupport_PhoneNumber,  //down
			State_User_Set_TechSupport_PhoneNumber,   //ok
			State_DebugMode_Start},&DirectSetValue,
		NULL,NULL,&LcdDisp_BackGround_Graph
	},
	//State_User_Change_Manufacturer_Logo+++++++++++++++++++++++++++++++++++++++++++++++++++++++
	{
		...
		0x91,"_","_",
		{State_User_Change_Manufacturer_Logo,   //up
			State_User_Change_Manufacturer_Logo,  //down
			State_User_Change_Manufacturer_Logo,   //ok
			State_DebugMode_Start},&DirectSetValue,
		NULL,NULL,&LcdDisp_BackGround_Graph
	},
	...
	//State_User_Change_MachineModel,+++++++++++++++++++++++++++++++++++++++++++++++++
	{
		...
		0x91,"_","_",
		{State_User_Change_MachineModel,   //up
			State_User_Change_MachineModel,  //down
			State_User_Change_MachineModel,   //ok
			State_DebugMode_Start},&DirectSetValue,
		NULL,NULL,&LcdDisp_BackGround_Graph
	},
