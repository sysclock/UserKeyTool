...
* File Name          : main.c
* Author             : LYG  setup~20170322
				YJL   20170326~	
* Version            : V2.0.1
* Date               : 06/13/2016
* Description        : BP700 视频拼接器的主程序Main program 
********************************************************************************
...
//	U8 LedOnFlag=1;
	...
	GpuSend("SPG(46);\r\n");//调用串口屏 启动菜单函数:启动中... ...调用了009图片，有公司logo
	//GpuSend("PIC(0,0,8);\r\n");//PIC(0,0,9);
	delay_ms(40);
