...
void Read_Screen_line_column_pixel(void)
{
	...
	for(i=0;i<8;i++)
	{
		Read_EEPROM_U16(E2ROM_SCENARIO_LINE_COL_PIXEL_ADDR+i*6,&(g_stitching_screen_line_column_pixel[0][i]));
		Read_EEPROM_U16(E2ROM_SCENARIO_LINE_COL_PIXEL_ADDR+i*6+3,&(g_stitching_screen_line_column_pixel[1][i]));
...
void Write_Screen_line_column_pixel(void)
{
	...
	for(i=0;i<8;i++)
	{
		Write_EEPROM_U16(E2ROM_SCENARIO_LINE_COL_PIXEL_ADDR+i*6,g_stitching_screen_line_column_pixel[0][i]);
		Write_EEPROM_U16(E2ROM_SCENARIO_LINE_COL_PIXEL_ADDR+i*6+3,g_stitching_screen_line_column_pixel[1][i]);
	}
}
