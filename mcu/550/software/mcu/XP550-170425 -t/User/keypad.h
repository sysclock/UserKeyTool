...
//20170213 lyg  
_KEYPADDEC_ _InputSourceType g_SubInput_pre;
...
//20170213 lyg
//设置单次使用或者演示使用所用变量
_KEYPADDEC_ U8 g_UserTry_168Demo_onoff;
_KEYPADDEC_ U8 g_Cmd54_168Demo_TimeLength;
