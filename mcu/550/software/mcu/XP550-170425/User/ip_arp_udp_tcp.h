...
extern void make_PcEth(unsigned char *buf);
extern void make_PcIp(unsigned char *buf);
extern void make_PcSeqAndSeqack(unsigned char *buf, U32 number);
extern void make_PcPort(unsigned char *buf);
...
extern void fill_tcp_data_pp(unsigned char *buf,unsigned  int num, const unsigned char *progmem_s);
