...
typedef enum _EEPROMAddressType
{
	...
	E2ROM_INPUT_SCHEDULE_ADDR=11*(EEPROMU8_SIZE+EEPROMU16_SIZE*2)+E2ROM_SAVEMODE_BEGIN_ADDR, //add one mode as default call mode
	...
	E2ROM_DeviceID_Addr=E2ROM_FULL_PART_ADDR+6, 
	...
	//´Ë´¦Ìí¼Ó
	E2ROM_HowLongTime_ADDR=E2ROM_VOLUME_ADDR+2, 
	E2ROM_Log_Num_ADDR=E2ROM_HowLongTime_ADDR+2, 
	
	E2ROM_EnableRecordLog_ADDR=E2ROM_Log_Num_ADDR+3,
	
	E2ROM_Log_Start_ADDR=E2ROM_EnableRecordLog_ADDR+2, 
